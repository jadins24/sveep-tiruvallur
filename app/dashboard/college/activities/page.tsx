...
const activities = [
  ...
  { id: 2, title: 'Digital Pledge Drive', date: 'Oct 25, 2024', status: 'Pending Approval', image: 'https://picsum.photos/seed/act2/400/300' },
  { id: 3, title: 'Poster Competition', date: 'Oct 26, 2024', status: 'Approved', image: 'https://picsum.photos/seed/act3/400/300' },
  { id: 4, title: 'Street Play on Voting', date: 'Oct 27, 2024', status: 'Pending Approval', image: 'https://picsum.photos/seed/act4/400/300' },
]
    ...
    <DashboardLayout>
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Activity Gallery</h1>
            <p className="text-slate-500">View and manage all SVEEP activities uploaded by your institution.</p>
          </div>
          <Link 
              ...
              >
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-black/40 p-1 text-[8px] text-white font-mono text-center">
                    VERIFIED SVEEP PORTAL • Govt Arts College
                  </div>
                </div>
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100">
                    ...
                    <button className="text-xs font-bold text-slate-600 hover:text-emerald-600 transition-colors">Edit</button>
                  </div>
                </div>
              </motion.div>
            ))}
